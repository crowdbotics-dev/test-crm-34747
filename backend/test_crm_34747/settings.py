"""
Django settings for test_crm_34747 project.
...
ROOT_URLCONF = 'test_crm_34747.urls'
...
WSGI_APPLICATION = 'test_crm_34747.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_crm_34747 API",
    "DESCRIPTION": "API documentation for test_crm_34747 App",
    "VERSION": "v1",
}
